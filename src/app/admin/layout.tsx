      ...
      <header className="shrink-0 border-b border-hairline/70 bg-obsidian/85 backdrop-blur-xl md:hidden">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/app"
              className="flex h-9 shrink-0 items-center gap-1 rounded-full border border-hairline bg-surface px-3 text-micro font-semibold text-muted hover:text-ink transition-colors"
            >
