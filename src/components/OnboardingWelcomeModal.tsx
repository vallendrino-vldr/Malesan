      ...
      <div className="relative w-full max-w-lg rounded-3xl border border-white/[0.12] bg-gradient-to-b from-surface-raised via-[#101014] to-[#0a0a0d] p-6 sm:p-8 shadow-2xl shadow-black/80 backdrop-blur-2xl transition-all animate-in zoom-in-95 duration-200">
        ...
        <div className="mt-5 space-y-2.5 rounded-2xl border border-white/[0.08] bg-[#09090b] p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-xs font-bold text-ink">{wm.card1Title}</p>
              <p className="text-micro text-muted">{wm.card1Desc}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-xs font-bold text-ink">{wm.card2Title}</p>
              <p className="text-micro text-muted">{wm.card2Desc}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-xs font-bold text-ink">{wm.card3Title}</p>
              <p className="text-micro text-muted">{wm.card3Desc}</p>
            </div>
          </div>
        </div>
