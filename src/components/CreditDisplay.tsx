...
export function CreditDisplay({ credits }: { credits: number }) {
  return (
    <Link
      ...
      className="flex h-10 shrink-0 items-center gap-2 rounded-full border border-hairline/80 bg-surface/60 px-3.5 sm:px-4 shadow-xs transition-all duration-200 hover:border-ember/40 hover:bg-surface-raised"
    >
