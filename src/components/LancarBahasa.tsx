...
import { GLOBAL_SCENARIOS, SCENARIO_CATEGORIES, GlobalScenario } from "@/lib/speaking/scenarios";
...
const PERSONAS: Array<{ id: Persona; name: string; tag: string; desc: string; accent: string; gender: "male" | "female" }> = [
  { id: "david", name: "David Kessler", tag: "Wall St MD (47)", accent: "New York", desc: "Tegas, menghargai waktu, negosiator deal jutaan dollar", gender: "male" },
  { id: "sarah", name: "Sarah Whitmore", tag: "Strategic Advisor (52)", accent: "London", desc: "Aksen British presisi tinggi, santun mematikan (ex-FCDO)", gender: "female" },
  { id: "alex", name: "Alex Reyes", tag: "Silicon Valley (31)", accent: "San Francisco", desc: "Cepat, santai, startup hustle, jargon tech & creative economy", gender: "male" },
  { id: "emma", name: "Emma Cho", tag: "Brand Director LA (29)", accent: "Los Angeles", desc: "Ekonomi kreator global, hangat di luar tapi negosiator tajam", gender: "female" },
];
...
const AUDIO_GATED_STAGES: AudioGatedStage[] = [
  {
    ...
    steps: [
      {
        ...
        wrongAudio: {
          ...
          translation: "Pelafalan 'Hek' dan getar lidah keras 'Rrr' (keliru).",
        },
        correctAudio: {
          ...
          translation: "H dibaca murni 'Eitch' dan R melengkung lembut 'Ar' (standar native).",
        },
        ...
        stepVoiceChallenge: {
          ...
          translation: "Huruf H diucapkan sebagai 'aitch' dan huruf R mengalir lembut.",
        },
      },
      {
        ...
        wrongAudio: {
          ...
          translation: "Ini dan itu, mereka berpikir dan terima kasih (aksen kaku Indoglish).",
        },
        correctAudio: {
          ...
          translation: "Ini dan itu, mereka berpikir dan berterima kasih tiga kali (luwes native).",
        },
        ...
        stepVoiceChallenge: {
          ...
          translation: "Aku pikir ini sangat bagus, terima kasih banyak.",
        },
      },
      {
        title: "Bunyi 'V' vs 'P'",
        ...
        wrongAudio: {
          ...
          translation: "Video favoritku sangat bagus (salah, bibir menutup rapat 'P').",
        },
        correctAudio: {
          ...
          translation: "Video favoritku sangat bagus (benar, gigi bergetar di bibir bawah 'V').",
        },
        ...
        stepVoiceChallenge: {
          ...
          translation: "Ini adalah video favoritku dan ini sangat bagus.",
        },
      },
      {
        ...
        wrongAudio: {
          ...
          translation: "Kami mengunjungi pulau itu (salah, huruf S disuarakan).",
        },
        correctAudio: {
          ...
          translation: "Kami mengunjungi pulau itu (benar, huruf S bisu).",
        },
        ...
        stepVoiceChallenge: {
          ...
          translation: "Kita akan mengunjungi pulau yang indah itu besok.",
        },
      },
      {
        ...
        wrongAudio: {
          ...
          translation: "Aku punya keraguan (salah, huruf B dibunyikan).",
        },
        correctAudio: {
          ...
          translation: "Aku tidak punya keraguan (benar, huruf B bisu).",
        },
        ...
        stepVoiceChallenge: {
          ...
          translation: "Aku tidak ragu sama sekali bahwa mereka akan melunasi utangnya.",
        },
      },
    ],
    exam: [
    ...
    voiceChallenge: {
      ...
      translation: "Aku tidak ragu sama sekali bahwa pulau ini adalah favoritku, terima kasih.",
    },
  },
  {
    id: 2,
    ...
    steps: [
      {
        ...
        wrongAudio: {
          ...
          translation: "Tunggu sebentar... tolong angkat... itu (terputus-putus seperti robot).",
        },
        correctAudio: {
          ...
          translation: "Tunggu sebentar, tolong angkat itu sekarang juga (mengalir menyatu).",
        },
        ...
        stepVoiceChallenge: {
          ...
          translation: "Tunggu sebentar, tolong angkat itu sekarang juga.",
        },
      },
      {
        ...
        wrongAudio: {
          ...
          text: "I am going to tell you what I want to do",
          sampleText: "I am going to tell you what I want to do.",
          explanation: "Terlalu kaku untuk percakapan harian.",
          translation: "Saya akan memberitahu Anda apa yang ingin saya lakukan (terlalu kaku & formal).",
        },
        correctAudio: {
          ...
          translation: "Gue bakal kasih tahu lo apa yang pengen gue lakuin (santai & mengalir alami).",
        },
        ...
        stepVoiceChallenge: {
          ...
          translation: "Aku bakal kasih tahu kamu apa yang mau aku lakuin.",
        },
      },
    ],
    exam: [
    ...
    voiceChallenge: {
      ...
      translation: "Tunggu sebentar, aku bakal angkat itu karena aku mau melihatnya.",
    },
  },
  {
    id: 3,
    ...
    steps: [
      {
        ...
        wrongAudio: {
          ...
          translation: "Aku setuju dengan pendapatmu (keliru tata bahasa karena pakai 'am').",
        },
        correctAudio: {
          ...
          translation: "Aku setuju sepenuhnya dengan pendapatmu (tata bahasa baku).",
        },
        ...
        stepVoiceChallenge: {
          ...
          translation: "Aku setuju sepenuhnya dengan proposalmu.",
        },
      },
      {
        ...
        wrongAudio: {
          ...
          translation: "Terima kasih sebelumnya atas bantuanmu (salah terjemahan harfiah).",
        },
        correctAudio: {
          ...
          translation: "Terima kasih sebelumnya atas bantuan dan masukanmu (baku profesional).",
        },
        ...
        stepVoiceChallenge: {
          ...
          translation: "Terima kasih sebelumnya atas dukungan dan masukannya.",
        },
      },
      {
        ...
        wrongAudio: {
          ...
          translation: "Silakan gabung bersama komunitas kami (pemborosan kata 'with').",
        },
        correctAudio: {
          ...
          translation: "Silakan gabung komunitas kami / gabung bersama kita untuk makan siang hari ini.",
        },
        ...
        stepVoiceChallenge: {
          ...
          translation: "Silakan gabung bersama tim kami untuk makan siang hari ini.",
        },
      },
    ],
    exam: [
    ...
    voiceChallenge: {
      ...
      focusTips: "Ucapkan 'I agree with you' (bukan I am agree), 'join us' (jangan tambah with setelah join), dan 'thanks in advance' (bukan thanks before).",
      sampleAudio: "I agree with you, please join us and thanks in advance.",
      translation: "Aku setuju sama kamu, silakan gabung bareng kita dan terima kasih sebelumnya.",
    },
  },
  {
    id: 4,
    ...
    steps: [
      {
        ...
        wrongAudio: {
          ...
          translation: "Kemarin saya pergi ke kantor dan beli makan siang (salah, pakai Verb 1 sekarang).",
        },
        correctAudio: {
          ...
          translation: "Kemarin saya pergi ke kantor, bertemu klien, dan beli makan siang (benar, pakai Verb 2).",
        },
        ...
        stepVoiceChallenge: {
          ...
          translation: "Kemarin aku pergi ke kantor dan bertemu klien.",
        },
      },
      {
        ...
        wrongAudio: {
          ...
          translation: "Beri aku laporan itu sekarang (terdengar kasar dan menuntut).",
        },
        correctAudio: {
          ...
          translation: "Bisakah Anda membagikan laporan itu saat Anda ada waktu? (sangat sopan & anggun).",
        },
        ...
        stepVoiceChallenge: {
          ...
          translation: "Bisakah Anda membagikan laporan itu saat Anda memiliki waktu luang?",
        },
      },
    ],
    exam: [
    ...
    voiceChallenge: {
      ...
      translation: "Bisakah Anda membantu saya? Kemarin saya pergi ke kantor dan membeli makan siang.",
    },
  },
  {
    id: 5,
    ...
    steps: [
      {
        ...
        wrongAudio: {
          ...
          translation: "Kamu dengar saya? Lihat layar saya sekarang (janggal dan tidak baku).",
        },
        correctAudio: {
          ...
          translation: "Apakah semua orang bisa melihat layar saya? Sarah, mikrofonmu masih termute.",
        },
        ...
        stepVoiceChallenge: {
          ...
          translation: "Apakah semua orang bisa melihat layar saya? Mikrofonmu saat ini masih termute.",
        },
      },
    ],
    exam: [
    ...
    voiceChallenge: {
      ...
      translation: "Apakah semua orang bisa melihat layar saya? Tolong buatkan saya satu es latte untuk dibungkus.",
    },
  },
  {
    id: 6,
    ...
    steps: [
      {
        ...
        wrongAudio: {
          ...
          translation: "Saya setuju dengan Anda dan terima kasih sebelumnya (kesalahan fatal Indoglish).",
        },
        correctAudio: {
          ...
          translation: "Bisakah Anda membagikan laporan itu? Terima kasih sebelumnya! (100% sempurna).",
        },
        ...
        stepVoiceChallenge: {
          ...
          translation: "Bisakah Anda meminjamkan laporan itu kepada saya? Terima kasih sebelumnya.",
        },
      },
    ],
    exam: [
    ...
    voiceChallenge: {
      ...
      translation: "Aku tidak ragu sama sekali bahwa aku akan mengunjungi pulau ini, bisakah kamu bergabung dengan kita?",
    },
  },
];
...
export function LancarBahasa({ cost = 2, credits = 0 }: { cost?: number; credits?: number }) {
  ...
  // Active Roleplay Scenario State & Category Filter
  const [activeScenario, setActiveScenario] = useState<GlobalScenario | null>(() => initialChatSession?.activeScenario || null);
  const [selectedCategory, setSelectedCategory] = useState<string>("all");
  const [showBriefingInCall, setShowBriefingInCall] = useState<boolean>(true);
  ...
  const triggerSlangify = async (messageId: string, text: string, context?: string) => {
    ...
    try {
      const res = await fetch("/api/speaking/slangify", {
        ...
        body: JSON.stringify({ text, context: context || (activeScenario ? activeScenario.setting.context_id : "General English") }),
      });
  ...
  // Helper to determine persona for Global Scenarios
  const getScenarioPersona = (s: GlobalScenario): Persona => {
    if (s.category === "price_negotiation") {
      return s.ai_persona.name.includes("Devon") ? "alex" : "david";
    }
    if (s.category === "client_complaint") {
      return "sarah";
    }
    if (s.category === "sv_interview") {
      return s.ai_persona.temperament.toLowerCase().includes("direct") ? "david" : "alex";
    }
    if (s.category === "sponsorship_pitch") {
      return "emma";
    }
    return "david";
  };
  ...
  const startCall = (scenarioItem?: GlobalScenario) => {
    if (credits < cost) {
      setFeedbackNotice(`Kredit lo kurang (${credits} tersisa). Butuh minimal ${cost} kredit.`);
      return;
    }
    const chosenPersona: Persona = scenarioItem ? getScenarioPersona(scenarioItem) : persona;
    if (scenarioItem) {
    ...
    const initialTranslate = scenarioItem
      ? scenarioItem.setting.context_id
    ...
    const initialSuggestions: SuggestedReply[] = scenarioItem
      ? scenarioItem.response_options.map((opt) => ({
          en: opt.script,
          id: `${opt.strategy} (${opt.tone})`,
  ...
  const toggleRecording = async () => {
    ...
    if (isRecording) {
      ...
      const activeP = activeScenario ? getScenarioPersona(activeScenario) : persona;
  ...
  const submitAudioChunk = async (audioBlob: Blob) => {
    ...
    setFeedbackNotice(null);
    const activeP = activeScenario ? getScenarioPersona(activeScenario) : persona;
    const activeScenId = activeScenario ? activeScenario.id : "daily";
    ...
    try {
      ...
      formData.append("scenario", activeScenId);
      formData.append(
        "history",
        JSON.stringify(
      ...
      const newMessages: ChatMessage[] = [
        ...
        },
        {
          ...
          missionAccomplished: data.missionAccomplished,
        },
      ];
  ...
  const submitTextMessage = async (explicitText?: string) => {
    ...
    try {
      ...
      setFeedbackNotice(err instanceof Error ? err.message : "Terjadi kesalahan.");
    } finally {
      setIsProcessing(false);
    }
  };
  ...
  return (
    <div className="w-full max-w-full overflow-x-hidden space-y-3 sm:space-y-4">
                ...
                <div className="rounded-2xl sm:rounded-3xl border border-ember/30 bg-gradient-to-b from-surface-raised to-surface p-3.5 sm:p-5 space-y-3.5 sm:space-y-4 shadow-md w-full min-w-0">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-2.5">
                      {/* WRONG AUDIO CARD */}
                      <div className="rounded-xl border border-rose-500/30 bg-rose-500/10 p-2.5 sm:p-3 flex flex-col justify-between gap-2.5">
                        <div className="space-y-1.5">
                          ...
                          {activeStep.wrongAudio.translation && (
                            <p className="text-[11px] text-rose-200/90 italic leading-snug bg-rose-950/40 px-2 py-1 rounded-md border border-rose-500/20">
                              <span className="font-semibold text-rose-300 not-italic text-[10px] mr-1">Arti:</span>
                              &ldquo;{activeStep.wrongAudio.translation}&rdquo;
                            </p>
                          )}
                          {activeStep.wrongAudio.explanation && (
                            <p className="text-[10px] text-muted leading-tight">{activeStep.wrongAudio.explanation}</p>
                          )}
                        </div>
                      ...
                      {/* CORRECT AUDIO CARD */}
                      <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-2.5 sm:p-3 flex flex-col justify-between gap-2.5">
                        <div className="space-y-1.5">
                          <div className="flex items-center justify-between gap-2">
                          ...
                          {activeStep.correctAudio.translation && (
                            <p className="text-[11px] text-emerald-200/90 italic leading-snug bg-emerald-950/40 px-2 py-1 rounded-md border border-emerald-500/20">
                              <span className="font-semibold text-emerald-300 not-italic text-[10px] mr-1">Arti:</span>
                              &ldquo;{activeStep.correctAudio.translation}&rdquo;
                            </p>
                          )}
                          {activeStep.correctAudio.explanation && (
                            <p className="text-[10px] text-muted leading-tight">{activeStep.correctAudio.explanation}</p>
                          )}
                        </div>
                  ...
                  <div className="rounded-xl border border-hairline bg-surface-raised p-2.5 text-[11px] sm:text-xs text-muted flex items-start gap-2">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="size-3.5 text-ember shrink-0 mt-0.5">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.439a8.966 8.966 0 0 1-4.5 0m4.5 0v1.5a1.5 1.5 0 0 1-1.5 1.5h-1.5a1.5 1.5 0 0 1-1.5-1.5v-1.5m0-13.5a6 6 0 1 1 12 0c0 2.22-1.206 4.16-3 5.197" />
                    </svg>
                  ...
                  <div className="rounded-2xl border border-ember/30 bg-gradient-to-b from-ember/10 via-surface to-surface p-3.5 sm:p-4 space-y-2.5 text-center shadow-xs">
                    ...
                    {currentChallenge.translation && (
                      <div className="pt-0.5">
                        <p className="text-[11px] sm:text-xs text-amber-200/95 italic bg-amber-950/40 px-3 py-1.5 rounded-xl border border-ember/25 inline-block max-w-full text-center">
                          <span className="font-semibold text-ember not-italic mr-1.5">Arti:</span>
                          &ldquo;{currentChallenge.translation}&rdquo;
                        </p>
                      </div>
                    )}

                    <div className="w-full">
                      <p className="text-[10px] sm:text-[11px] font-mono font-medium text-muted bg-surface-raised/90 px-3 py-1.5 rounded-xl border border-hairline/80 whitespace-normal break-words leading-relaxed text-center flex items-center justify-center gap-1.5">
                        ...
                        <span>{currentChallenge.easyPronunciation}</span>
                      </p>
                    </div>
                    ...
                    <div className="text-[10px] sm:text-[11px] text-muted border-t border-hairline/50 pt-2 text-center leading-tight flex items-center justify-center gap-1.5">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="size-3.5 text-ember shrink-0">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.439a8.966 8.966 0 0 1-4.5 0m4.5 0v1.5a1.5 1.5 0 0 1-1.5 1.5h-1.5a1.5 1.5 0 0 1-1.5-1.5v-1.5m0-13.5a6 6 0 1 1 12 0c0 2.22-1.206 4.16-3 5.197" />
                      </svg>
                      <span><b>Kunci:</b> {currentChallenge.focusTips}</span>
                    </div>
                  </div>
                    ...
                    >
                      <div className="flex items-start justify-between gap-2.5">
                        ...
                        {m.role === "assistant" && (
                          <button
                            type="button"
                            onClick={() => playSpeechAudio(m.text, activeScenario ? getScenarioPersona(activeScenario) : persona)}
                            title="Putar suara"
                  ...
                  <div className="flex flex-col items-start animate-in fade-in duration-200">
                    <div className="rounded-2xl border border-hairline/80 bg-surface px-3.5 py-2 text-xs text-muted flex items-center gap-2 shadow-xs">
                      ...
                      <span className="text-[11px] font-mono text-muted/90 font-medium">
                        {PERSONAS.find((p) => p.id === (activeScenario ? getScenarioPersona(activeScenario) : persona))?.name || "Partner"} is thinking...
                      </span>
                    </div>
                  </div>
                )}
      ...
      {/* ========================================================================= */}
      {/* MODE 2: SIMULASI SKENARIO 20 GLOBAL MASTER (ROLEPLAY CHAMBER) */}
      {/* ========================================================================= */}
          ...
          {!isCalling ? (
            <div className="space-y-4 sm:space-y-5">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-hairline/60 pb-3">
                <div>
                  <h3 className="font-display text-sm sm:text-base font-bold text-ink flex items-center gap-2">
                    <span className="size-2 rounded-full bg-ember animate-pulse" />
                    20 Skenario Negosiasi Global &amp; Cuan Dollar ($)
                  </h3>
                  <p className="text-[11px] sm:text-xs text-muted mt-0.5">
                    Latihan negosiasi harga proyek remote ($3k-$10k USD), komplain klien luar negeri, dan interview Silicon Valley.
                  </p>
                </div>
                <div className="text-[11px] font-mono text-muted bg-surface-raised px-2.5 py-1 rounded-xl border border-hairline shrink-0">
                  {GLOBAL_SCENARIOS.length} Skenario Master
                </div>
              </div>
                    ...
                    <button
                      ...
                      className={`h-8 px-3 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer ${
                        isActive
                          ...
                          : "bg-surface text-muted hover:text-ink border border-hairline hover:bg-surface-raised"
                      }`}
                    >
                      <span>{cat.label_id}</span>
                    </button>
                  );
                })}
              </div>

              {/* 20 SCENARIO CARDS GRID */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {GLOBAL_SCENARIOS.filter((s) => selectedCategory === "all" || s.category === selectedCategory).map((s) => {
                  const categoryMeta = SCENARIO_CATEGORIES.find((c) => c.key === s.category);
                  return (
                    <div
                      key={s.id}
                      className="rounded-xl sm:rounded-2xl border border-hairline bg-surface-raised p-3.5 sm:p-4 flex flex-col justify-between space-y-3 hover:border-ember/60 transition-all group relative overflow-hidden"
                    >
                      <div className="space-y-2.5">
                        {/* Card Header: Category & Stakes */}
                        <div className="flex items-center justify-between gap-1.5">
                          <span className="text-[10px] font-bold text-ember bg-ember/15 px-2 py-0.5 rounded-lg border border-ember/25 truncate">
                            {categoryMeta?.label_id.split("(")[0] || s.category}
                          </span>
                          {s.setting.stakes_usd && (
                            <span className="text-[10px] font-mono font-bold text-emerald-400 bg-emerald-500/15 px-2 py-0.5 rounded-lg border border-emerald-500/30 shrink-0">
                              💰 ${s.setting.stakes_usd.toLocaleString()} USD
                            </span>
                          )}
                        </div>
                        ...
                        {/* Title & Counterpart */}
                        <div>
                          <h4 className="font-display text-xs sm:text-sm font-bold text-ink group-hover:text-ember transition-colors leading-snug">
                            {s.title}
                          </h4>
                          <p className="text-[10px] sm:text-[11px] text-muted font-medium mt-0.5 truncate">
                            Lawan: <span className="text-ink font-bold">{s.ai_persona.name}</span> ({s.ai_persona.role} • {s.ai_persona.company})
                          </p>
                        </div>

                        {/* Context summary */}
                        <p className="text-[11px] text-muted leading-relaxed line-clamp-2">
                          {s.setting.context_id}
                        </p>

                        {/* Tag Pills */}
                        <div className="flex flex-wrap gap-1 pt-1">
                          {s.tags.slice(0, 3).map((tag, tIdx) => (
                            <span key={tIdx} className="text-[9px] font-mono text-muted/80 bg-surface px-1.5 py-0.2 rounded border border-hairline/60">
                              #{tag}
                            </span>
                          ))}
                        </div>
                      ...
                      <button
                        type="button"
                        onClick={() => startCall(s)}
                        className="btn-ember w-full h-9 rounded-xl text-xs font-bold text-obsidian shadow-sm hover:brightness-105 cursor-pointer flex items-center justify-center gap-1.5 mt-2"
                      >
                        <span>Mulai Simulasi (${s.setting.stakes_usd ? `$${s.setting.stakes_usd.toLocaleString()}` : "Pro"})</span>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" className="size-3.5">
            ...
            /* ACTIVE ROLEPLAY CHAMBER */
            <div className="space-y-3.5 sm:space-y-4">
              {/* Header Bar */}
              <div className="rounded-2xl border border-ember/30 bg-surface-raised/90 p-3 sm:p-4 flex flex-wrap items-center justify-between gap-2 shadow-sm">
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    <span className="size-2 rounded-full bg-emerald-400 animate-pulse shrink-0" />
                    <h3 className="font-display text-xs sm:text-sm font-bold text-ink truncate">
                    ...
                    {activeScenario?.setting.stakes_usd && (
                      <span className="text-[10px] font-mono font-bold text-emerald-400 bg-emerald-500/15 px-2 py-0.2 rounded-lg border border-emerald-500/30">
                        ${activeScenario.setting.stakes_usd.toLocaleString()} USD
                      </span>
                    )}
                  </div>
                  <p className="text-[10px] sm:text-[11px] text-muted truncate mt-0.5">
                    Lawan Bicara: <strong className="text-ink">{activeScenario?.ai_persona.name}</strong> ({activeScenario?.ai_persona.role} • {activeScenario?.ai_persona.company})
                  </p>
                </div>
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <button
                    type="button"
                    onClick={() => setShowBriefingInCall((prev) => !prev)}
                    className="h-7 px-2.5 rounded-lg border border-ember/30 bg-ember/10 text-ember text-[10px] font-bold cursor-pointer"
                  >
                    {showBriefingInCall ? "Tutup Briefing" : "Lihat Briefing Taktis"}
                  </button>
                  <button
                    type="button"
                    onClick={endCall}
                    className="h-7 px-3 rounded-lg border border-rose-500/40 bg-rose-500/15 text-rose-300 text-[10px] font-bold cursor-pointer hover:bg-rose-500/25"
                  >
                    Akhiri Simulasi
                  </button>
                </div>
              ...
              {/* DIPLOMACY BRIEFING DRAWER */}
              {showBriefingInCall && activeScenario && (
                <div className="rounded-2xl border border-ember/30 bg-surface p-3 sm:p-4 space-y-2.5 text-xs animate-in fade-in duration-200 shadow-sm">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
                    <div className="space-y-1">
                      <span className="text-[10px] font-bold text-ember uppercase tracking-wider flex items-center gap-1">
                        ...
                        Situasi &amp; Motivasi Tersembunyi:
                      </span>
                      <p className="text-[11px] text-ink leading-relaxed font-medium">{activeScenario.setting.context_id}</p>
                      <p className="text-[10px] text-muted italic">Rahasia Klien: {activeScenario.setting.hidden_client_motivation}</p>
                    </div>
                    <div className="space-y-1">
                      <span className="text-[10px] font-bold text-emerald-400 uppercase tracking-wider flex items-center gap-1">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="size-3 text-emerald-400">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.439a8.966 8.966 0 0 1-4.5 0m4.5 0v1.5a1.5 1.5 0 0 1-1.5 1.5h-1.5a1.5 1.5 0 0 1-1.5-1.5v-1.5m0-13.5a6 6 0 1 1 12 0c0 2.22-1.206 4.16-3 5.197" />
                        </svg>
                        Prinsip Diplomasi &amp; Anti-Sungkan:
                      </span>
                      <p className="text-[11px] text-ink leading-relaxed font-medium">{activeScenario.diplomacy_insight.core_principle}</p>
                      <p className="text-[10px] text-rose-300 flex items-center gap-1">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="size-3 text-rose-400 shrink-0">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
                        </svg>
                        <span>Jebakan Orang Indo: {activeScenario.diplomacy_insight.indonesian_pitfall}</span>
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {/* CHAT LOG STREAM */}
              <div className="h-64 sm:h-80 overflow-y-auto rounded-2xl border border-hairline/60 bg-surface-raised/40 p-3 sm:p-4 space-y-3 custom-scrollbar">
                {messages.map((m) => (
                  <div
                    key={m.id}
                  ...
                  >
                      ...
                      {m.role === "assistant" && m.translateId && (
                        <div className="border-t border-hairline/50 pt-1">
                          {showTranslations[m.id] ? (
                            ...
                            <button
                              type="button"
                              onClick={() => setShowTranslations((prev) => ({ ...prev, [m.id]: true }))}
                              className="text-[10px] font-bold text-ember hover:underline cursor-pointer"
                            >
                              Lihat Terjemahan Indo
                            </button>
                          )}
                    ...
                    {/* TWO-LAYER COACH BLOCK */}
                    {m.tip && (
                      <div className="max-w-[92%] sm:max-w-[85%] rounded-xl border border-amber-500/30 bg-amber-500/10 p-2.5 text-xs text-ink space-y-1 animate-in fade-in">
                        <div className="flex items-center justify-between gap-2">
                          <span className="text-[10px] font-bold text-amber-400 uppercase tracking-wider flex items-center gap-1">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="size-3 text-amber-400">
                              <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.439a8.966 8.966 0 0 1-4.5 0m4.5 0v1.5a1.5 1.5 0 0 1-1.5 1.5h-1.5a1.5 1.5 0 0 1-1.5-1.5v-1.5m0-13.5a6 6 0 1 1 12 0c0 2.22-1.206 4.16-3 5.197" />
                            </svg>
                            Coach Insight:
                          </span>
                          {m.pitfallTag && (
                            <span className="text-[9px] font-mono font-bold text-amber-300 bg-amber-500/20 px-1.5 py-0.2 rounded border border-amber-500/30">
                              {m.pitfallTag}
                            </span>
                          )}
                        </div>
                        <p className="text-[11px] text-muted leading-relaxed font-medium">{m.tip}</p>
                        {m.roast && (
                          <p className="text-[10px] text-amber-300 italic">🔥 {m.roast}</p>
                        )}
                      </div>
                    )}
                  </div>
                ...
                {isProcessing && (
                  <div className="flex flex-col items-start animate-in fade-in duration-200">
                    <div className="rounded-2xl border border-hairline/80 bg-surface px-3.5 py-2 text-xs text-muted flex items-center gap-2 shadow-xs">
                      ...
                      <span className="text-[11px] font-mono text-muted/90 font-medium">
                        {activeScenario?.ai_persona.name || "Partner"} is thinking...
                      </span>
                    </div>
                  </div>
                )}
              ...
              {/* 3 STRATEGIC RESPONSE DOCK (CONTEKAN TAKTIS DARI CLAUDE OPUS 5) */}
              {messages.length > 0 && messages[messages.length - 1].role === "assistant" && messages[messages.length - 1].suggestedReplies && (
                <div className="space-y-1.5 animate-in fade-in duration-200">
                  <span className="text-[10px] font-bold text-ember uppercase tracking-wider flex items-center gap-1">
                    ⚡ 3 Pilihan Respons Strategis (Klik untuk kirim/latih):
                  </span>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-1.5">
                    {messages[messages.length - 1].suggestedReplies?.map((item, idx) => (
                      <button
                        ...
                        disabled={isProcessing}
                        className="rounded-xl border border-hairline bg-surface p-2.5 text-left hover:border-ember/60 hover:bg-surface-raised transition-all group disabled:opacity-50 cursor-pointer flex flex-col justify-between space-y-1 min-w-0"
                      >
                        <span className="text-[10px] font-bold text-ember uppercase tracking-wider block truncate">
                          {item.strategy || `Strategi ${String.fromCharCode(65 + idx)}`}
                        </span>
                        <p className="font-semibold text-xs text-ink group-hover:text-ember transition-colors leading-snug line-clamp-2">
                          &ldquo;{item.en}&rdquo;
                        </p>
                        <span className="text-[10px] text-muted block truncate">{item.id}</span>
                      </button>
                    ))}
                  </div>
                </div>
              ...
              <div className="rounded-xl sm:rounded-2xl border border-hairline/60 bg-surface-raised p-2 flex flex-col items-center justify-center">
                <canvas ref={canvasRef} width={400} height={32} className="w-full h-7" />
                <p className="text-[10px] font-mono text-muted mt-0.5 text-center">
                  {isRecording
                    ? "Mendengarkan... Klik tombol merah untuk kirim"
                    : isPlayingAudio
                    ? `${activeScenario?.ai_persona.name || "Partner"} sedang berbicara...`
                    : isProcessing
                    ? "Memproses suara..."
                    : "Tekan tombol bicara atau ketik pesan"}
                </p>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-center">
                  <button
                    ...
                    onClick={toggleRecording}
                    disabled={isProcessing}
                    className={`h-10 sm:h-12 px-6 sm:px-8 rounded-2xl font-display text-xs sm:text-sm font-bold transition-all flex items-center gap-2 shadow-lg w-full sm:w-auto justify-center cursor-pointer ${
                      isRecording
                        ? "bg-rose-500 text-white animate-pulse ring-4 ring-rose-500/30"
                        : isProcessing
                        ? "bg-surface-raised text-muted cursor-not-allowed border border-hairline"
                ...
                <div className="flex items-center gap-1.5 rounded-xl border border-hairline bg-surface-raised p-1 focus-within:border-ember/60 transition-all">
                  <input
                    ...
                    placeholder="Atau ketik respons bahasa Inggris lo di sini..."
                    disabled={isProcessing}
                  ...
                  <button
                    ...
                    onClick={() => submitTextMessage()}
                    disabled={!textInput.trim() || isProcessing}
                    className="btn-ember h-8 px-3.5 rounded-lg font-display text-xs font-bold text-obsidian disabled:opacity-50 shrink-0 cursor-pointer"
                  >
                    Kirim
                  </button>
                </div>
